...
export function Button({
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-700 hover:to-fuchsia-700 text-white focus:ring-violet-500 shadow-lg shadow-violet-500/25',
    secondary: 'bg-gray-800 hover:bg-gray-700 text-white focus:ring-gray-500',
    outline: 'border-2 border-gray-700 hover:border-violet-500 text-gray-300 hover:text-white focus:ring-violet-500',
